	...
	<div class="col-sm-4">
		<form class="form-horizontal" action="persona_evalua.php">
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-sm-12">
		            <input type="number" class="form-control" id="nombres" name="dni" value="<?php echo $id; ?>" placeholder="DNI">
		        </div>
		    </div>
		    <div class="form-group">
		        <label for="area" class="col-sm-12 ">Apellido Paterno:</label>
		        <div class="col-sm-12">
		            <input type="text" class="form-control" id="area" name="apePat" value="<?php echo $apellidoPat; ?>" placeholder="Apellido Paterno">
		        </div>
		    </div>
		    <div class="form-group">
		        <label for="area" class="col-sm-12 ">Apellido materno:</label>
		        <div class="col-sm-12">
		            <input type="text" class="form-control" id="area" name="apeMat" value="<?php echo $apellidoMat; ?>" placeholder="Apellido materno">
		        </div>
		    </div><div class="form-group">
		        <label for="area" class="col-sm-12 ">Nombre:</label>
		        <div class="col-sm-12">
		            <input type="text" class="form-control" id="area" name="nombre" value="<?php echo $nombre; ?>" placeholder="Nombre">
		        </div>
		    </div>
