	...
	<div class="col-sm-4">
		<form class="form-horizontal" action="titulado_evalua.php">
			<input type="hidden" name="id" value="<?php echo $id; ?>">
		     ...
		     <div class="form-group">
		        ...
		        <div class="col-sm-12">
			        ...
			        <select type="text" style="width: 100%"class=" form-control js-example-basic-single" name="dni" >
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-sm-12">
		            <input type="text" class="form-control"  name="num_titulo" value="<?php echo $num_titulo; ?>" placeholder="N° de titulo">
		        </div>
		    </div>
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-sm-12">		            
			        <select type="text" class="form-control js-example-basic-single" style="width: 100%" name="cod_mod" >
			        	<option value=" " >Elija una Opción</option>
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-sm-12">
		            <input type="date" class="form-control"  name="fecha_titulo" value="<?php echo $fecha_titulo; ?>" placeholder="Fecha">
		        </div>
		    </div>
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-sm-12">
		            <select type="text" class="form-control js-example-basic-single" style="width: 100%" name="titulo_id" >
		            <option value=" " >Elija una Opción</option>
